 ...
 */
public class DragLayoutThree extends ViewGroup {
    ...
    public DragLayoutThree(Context context) {
        super(context);
        init(context);
    }

    public DragLayoutThree(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public DragLayoutThree(Context context, AttributeSet attrs, int defStyle) {
