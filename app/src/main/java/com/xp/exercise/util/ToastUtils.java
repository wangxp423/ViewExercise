...
import com.xp.exercise.AppApplication;
...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(AppApplication.INSTANCE.getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(AppApplication.INSTANCE.getResources().getString(resId), args), duration);
    }
...
//        if (isJumpWhenMore) cancelToast();
        if (sToast == null) {
            sToast = Toast.makeText(AppApplication.INSTANCE, text, duration);
        } else {
            sToast.setText(text);
