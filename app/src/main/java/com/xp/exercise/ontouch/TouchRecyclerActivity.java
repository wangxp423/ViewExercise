 ...
 * @类描述：应用常量类
 * @创建人：Wangxiaopan
 * @创建时间：2018/9/10 0010 12:56
 * @修改人：
 * @修改时间：2018/9/10 0010 12:56
 * @修改备注：
 */
public class TouchRecyclerActivity extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ontouch_activity_recyclerview);
        NormalRecyclerView recyclerView = (NormalRecyclerView) findViewById(R.id.touch_recyclerview);
